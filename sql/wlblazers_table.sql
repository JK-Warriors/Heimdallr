...
CREATE TABLE `db_cfg_oracle` (
  ...
  `host_pwd` varchar(100)  DEFAULT NULL,
  `host_protocol` tinyint(2) DEFAULT '0' comment '0:ssh2; 1:telnet',
  `monitor` tinyint(2) DEFAULT '1',
  ...
  `alarm_fb_space` tinyint(2) NOT NULL DEFAULT '1',
  `alarm_asm_space` tinyint(2) NOT NULL DEFAULT '1',
  ...
  `threshold_warning_fb_space` smallint(10) NOT NULL DEFAULT '85',
  `threshold_warning_asm_space` smallint(10) NOT NULL DEFAULT '85',
  ...
  `threshold_critical_fb_space` smallint(4) NOT NULL DEFAULT '95',
  `threshold_critical_asm_space` smallint(4) NOT NULL DEFAULT '95',
  `filter_tbs` varchar(1000) DEFAULT NULL,
  `is_delete` tinyint(1) NOT NULL DEFAULT '0',
  `display_order` smallint(4) NOT NULL DEFAULT '0',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `db_cfg_oracle_dg` (
  ...
  `group_name` varchar(200),
  `primary_db_id` int(10),
  `primary_db_dest` tinyint(2),
  `standby_db_id` int(10),
  `standby_db_dest` tinyint(2),
  `fb_retention` int(10),
  `shift_vip` tinyint(1),
  `node_vips` varchar(400),
  `network_card_p` varchar(100),
  `network_card_s` varchar(100),
  `is_switch` tinyint(1) DEFAULT 0,
  `is_delete` tinyint(1) NOT NULL DEFAULT '0',
  `on_process` tinyint(1) DEFAULT 0,
  `on_switchover` tinyint(1) DEFAULT 0,
...
CREATE TABLE `db_cfg_os` (
  ...
  `filter_os_disk` varchar(1000) DEFAULT NULL,
  `is_delete` tinyint(1) NOT NULL DEFAULT '0',
  `display_order` smallint(4) NOT NULL DEFAULT '0',
...
-- ----------------------------
-- Table structure for mysql_dr_p
-- ----------------------------
DROP TABLE IF EXISTS `mysql_dr_p`;
CREATE TABLE `mysql_dr_p` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) DEFAULT NULL,
  `read_only` varchar(10) DEFAULT NULL,
  `gtid_mode` varchar(10) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for mysql_dr_p_his
-- ----------------------------
DROP TABLE IF EXISTS `mysql_dr_p_his`;
CREATE TABLE `mysql_dr_p_his` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) NOT NULL,
  `read_only` varchar(10) DEFAULT NULL,
  `gtid_mode` varchar(10) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for mysql_dr_s
-- ----------------------------
DROP TABLE IF EXISTS `mysql_dr_s`;
CREATE TABLE `mysql_dr_s` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) DEFAULT NULL,
  `read_only` varchar(10) DEFAULT NULL,
  `gtid_mode` varchar(10) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for mysql_dr_s_his
-- ----------------------------
DROP TABLE IF EXISTS `mysql_dr_s_his`;
CREATE TABLE `mysql_dr_s_his` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) NOT NULL,
  `read_only` varchar(10) DEFAULT NULL,
  `gtid_mode` varchar(10) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for sqlserver_status_his
-- ----------------------------
DROP TABLE IF EXISTS `sqlserver_status_his`;
CREATE TABLE `sqlserver_status_his` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `server_id` smallint(4) NOT NULL DEFAULT '0',
  `host` varchar(30) NOT NULL,
  `port` varchar(10) NOT NULL,
