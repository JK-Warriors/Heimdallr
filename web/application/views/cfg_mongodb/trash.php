...
<div class="btn-toolbar">
    <a class="btn btn " href="<?php echo site_url('cfg_mongodb/index') ?>"><i class="icon-list"></i> <?php echo $this->lang->line('list'); ?></a>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
		...
		<td><?php echo check_on_off($item['alarm_current_queue']) ?></td>
         <td><a href="<?php echo site_url('cfg_mongodb/recover/'.$item['id']) ?>" title="<?php echo $this->lang->line('recover'); ?>"><i class="icon-repeat"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo site_url('cfg_mongodb/forever_delete/'.$item['id']) ?>" class="confirm_delete" title="<?php echo $this->lang->line('forever_delete'); ?>" ><i class="icon-remove"></i></a></td>
	</tr>
 <?php endforeach;?>
<tr>
<td colspan="11">
