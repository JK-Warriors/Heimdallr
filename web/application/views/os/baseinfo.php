...
<form name="form" class="form-inline" method="get" action="<?php site_url('wl_os/baseinfo') ?>" >
 <select name="application_id" class="input-small" style="width: 120px;">
  ...
  <a href="<?php echo site_url('wl_os/baseinfo') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
</form>                
</div>
