...
<form name="form" class="form-horizontal" method="post" action="<?php echo site_url('cfg_oracle/add_dg') ?>" >
...
<div class="well">
 ...
 <?php foreach ($dglist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td>
        <a href="<?php echo site_url('cfg_oracle/dg_delete/'.$item['id']) ?>" class="confirm_delete" title="<?php echo $this->lang->line('delete'); ?>" ><i class="icon-remove"></i></a>
        </td>
	</tr>
 <?php endforeach;?>
<tr>
