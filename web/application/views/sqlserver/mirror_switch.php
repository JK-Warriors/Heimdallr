...
<ul class="breadcrumb">
            <li class="active"><a href="<?php echo site_url('wl_sqlserver/index'); ?>"><?php echo $this->lang->line('_Oracle Monitor'); ?></a></li><span class="divider">/</span></li>
            <li class="active"><a href="<?php echo site_url('wl_sqlserver/replication'); ?>"><?php echo $this->lang->line('_Mirror List'); ?></a></li><span class="divider">/</span></li>
            <li class="active"><?php echo $this->lang->line('_Mirror Manage'); ?></li>
...
<form id="form_switch" class="form-inline" method="post" action="" >
    <a class="btn btn " href="<?php echo site_url('wl_sqlserver/replication') ?>"><i class="icon-return"></i> <?php echo $this->lang->line('return'); ?></a>
...
<div style="padding: 19px; <?php if($setval['id']==""){echo "display:none;";} ?>" >
    <div style='padding: 20px 120px 0px 60px; height:100px; overflow:hidden'>
        ...
        <label name="pri_dbname" class="control-label" for=""><?php echo $this->lang->line('db_name'); ?>：<?php echo $primary_db[0]['p_db_name'] ?></label>
        <label name="pri_dbstatus" class="control-label" for=""><?php echo $this->lang->line('db_version'); ?>：<?php echo $primary_db[0]['p_db_version'] ?></label>
        ...
        <label name="sta_dbname" class="control-label" for=""><?php echo $this->lang->line('db_name'); ?>：<?php echo $standby_db[0]['s_db_name'] ?></label>
        <label name="sta_dbstatus" class="control-label" for=""><?php echo $this->lang->line('db_status'); ?>：<?php echo check_mirror_state($standby_db[0]['s_state']) ?></label>
...
<div style='padding: 5px 0px 0px 200px; height:150px;'>
    <div style="float:left;"><img src="<?php if($primary_db[0]['p_connect']==0){echo "./images/connect_error.png";} else{echo "./images/primary_db.png";}  ?> "/></div> 
        ...
        <label style='padding: 0px 0px 0px 120px;' class="control-label" for="">LSN: <?php echo $standby_db[0]['s_end_log_lsn'] ?></label>
        <img src="
        <?php
        if($standby_db[0]['s_state']==2){echo "./images/trans_alarm.png";}   #trans_alarm
        elseif($standby_db[0]['s_state']!=2 and $standby_db[0]['s_state']!=4){echo "./images/trans_error.png";}
...
var base_url = "<?php echo site_url('wl_sqlserver/mirror_switch?group_id=') ?>";
...
var query_url="<?php echo site_url('wl_sqlserver/mirror_progress?group_id=') ?>" + group_id.toString();
