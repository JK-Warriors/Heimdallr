...
<form name="form" class="form-inline" method="get" action="<?php echo site_url('wl_lock/index') ?>" >
  ...
  <a href="<?php echo site_url('wl_lock/index') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><center><?php echo $item['host'] ?></td>
				<td><center><a href="<?php echo site_url('wl_lock/view_lock?id='.$item['id'].'&db_type='.$item['db_type']) ?>"><?php echo $this->lang->line('view_lock'); ?></a></td>
	</tr>
 <?php endforeach;?>
 <?php }else{  ?>
<tr>
