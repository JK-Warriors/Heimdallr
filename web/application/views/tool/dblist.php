...
<ul class="breadcrumb">
            <li class="active"><a href="<?php echo site_url('wl_tool/dblist'); ?>"><?php echo $this->lang->line('_Tool Box'); ?></a></li><span class="divider">/</span></li>
...
<form name="form" class="form-inline" method="get" action="<?php echo site_url('wl_tool/lock') ?>" >
  ...
  <a href="<?php echo site_url('wl_tool/dblist') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
 ...
 <?php foreach ($datalist  as $item):?>
    <tr style="font-size: 12px;">
        ...
        <td><center><?php echo check_db_status_level($item['connect'],$item['connect_tips']) ?></td>
				<td><center><a href="<?php echo site_url('wl_tool/full_check?server_id='.$item['server_id'].'&db_type='.$item['db_type']) ?>"><?php echo $this->lang->line('healthcheck'); ?></a></td>
	</tr>
 <?php endforeach;?>
 <?php }else{  ?>
<tr>
