...
<div class="btn-toolbar">
    ...
    <a class="btn btn-primary " href="<?php echo site_url('cfg_mysql/add_dr') ?>"><i class="icon-plus"></i> <?php echo $this->lang->line('add_dr'); ?></a>
...
<form name="form" class="form-inline" method="get" action="" >
 ...
 <input type="text" id="tags"  name="tags" value="<?php echo $setval['tags']; ?>" placeholder="<?php echo $this->lang->line('please_input_tags'); ?>" class="input-medium" >
  ...
  <a href="<?php echo site_url('cfg_mysql/index') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
