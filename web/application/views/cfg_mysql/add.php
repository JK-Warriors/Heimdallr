...
<form id="form" name="form" class="form-horizontal" method="post" action="<?php echo site_url('cfg_mysql/add') ?>" >
...
<div class="well">
   ...
   <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="port"  name="port" value="<?php echo set_value('port','3306'); ?>" >
      <span class="help-inline"></span>
    </div>
   </div>
   ...
   <hr />
    ...
    <div class="controls">
        ...
        &nbsp;&nbsp;<?php echo $this->lang->line('threshold'); ?>&nbsp;<input type="text" id="bigtable_size" class="input-small" placeholder="" name="bigtable_size" value="1024" >&nbsp;&nbsp;MB
    </div>
    </div>
