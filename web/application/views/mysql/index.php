...
<form name="form" class="form-inline" method="get" action="<?php echo site_url('wl_mysql/index') ?>" >
 ...
 <input type="text" id="tags"  name="tags" value="<?php echo $setval['tags']; ?>" placeholder="<?php echo $this->lang->line('please_input_tags'); ?>" class="input-medium" >
  ...
  <a href="<?php echo site_url('wl_mysql/index') ?>" class="btn btn-warning"><i class="icon-repeat"></i> <?php echo $this->lang->line('reset'); ?></a>
