...
class cfg_mongodb extends Front_Controller {
    ...
    public function index(){
        ...
        $this->layout->view("cfg_mongodb/index",$data);
    }
    ...
    public function add(){
        ...
        $this->layout->view("cfg_mongodb/add",$data);
    }
    ...
    public function edit($id){
        ...
        $this->layout->view("cfg_mongodb/edit",$data);
    }
     ...
     */
     function batch_add(){
        ...
        $this->layout->view("cfg_mongodb/batch_add",$data);
     }
